  ...
  return (
    <article className="card panel">
      ...
      <section className="stack">
        ...
        >
          {/* class=, not className= — React passes className through literally
              on custom elements, so the CSS hooks below would never match. */}
          <sp-dropzone class="dropzone">
          ...
          <sp-progress-bar class="upload-progress" label="Uploading…" progress="0" hidden={true} />
